...
f = @(x) cos(x); % Cambia esta función según tus necesidades

% Definición del intervalo [a, b] y el número de puntos de muestreo
a = 0;
...
x0 = 1.0; % Punto en el que deseas calcular la derivada
index_x0 = find(x == x0); % Encuentra el índice correspondiente
